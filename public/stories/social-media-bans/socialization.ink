...
=== Need_Real_Investment ===
If we're serious about "go outside," we need real alternatives—and that requires investment.

But there are better ways to handle digital spaces too.

*   [Show me the better way for digital spaces.]
    ~ navigateTo("better-parental-controls")
    -> END
*   [Who gets hurt most by bans?]
    -> Marginalized_Groups
